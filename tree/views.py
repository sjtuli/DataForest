...
def node_detail(request, department_id):
    ...
    return render(request, 'question/content_node.html', context={'user': user, 'department': department, 'node': node,
                                                                  'question': question, 'data':_data, 'nodefile':_nodefile })
...
def modify_post(request, department_id):
    ...
    if request.method == 'GET':
        return render(request, "question/modify_post.html",
